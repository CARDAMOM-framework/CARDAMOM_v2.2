#pragma once
int EDC1_1003(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[16-1]==1)) & (pars[27]<pars[28] | pars[27]<pars[29])){EDC=0;EDCD->PASSFAIL[16-1]=0;}
