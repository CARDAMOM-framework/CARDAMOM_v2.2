...
int DALEC_831(DATA DATA, double const *pars)
{
...
double g;
/*SGS 7/17/19: Temp scaling factor*/
/* local variable definition */
/* PARS34 AND 35 */
int Tminmin = pars[33] - 273.15; 
int Tminmax = pars[34] - 273.15; /* optimization Sept. 17, 2019*/
...
/*printf("%2.2f\n",g);*/
/*int length = sizeof(DATA.MET[m+1])/sizeof(int); */
/*printf("length = %d",length);*/

/*GPP*/
FLUXES[f+0]=ACM(gpppars,constants)*fmin(POOLS[p+6]/pars[25],1)*g; /*edit code here; times g?*/ 
/*printf("GPP = %2.2f\n",FLUXES[f+0]);*/

/*Evapotranspiration (VPD = DATA.MET[m+7])*/
FLUXES[f+28]=FLUXES[f+0]*DATA.MET[m+7]/pars[23];

/*double length = sizeof(FLUXES[f+28]);*/
/*printf("length = %2.2f\n",length);*/
